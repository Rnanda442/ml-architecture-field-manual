...
function RnnComparison() {
  return (
    <section className="rnn-comparison" aria-label="RNN LSTM GRU comparison">
      <article>
        <span>RNN</span>
        <b>simple recurrent state</b>
        <p>One hidden state carries compressed history through shared recurrent weights.</p>
      </article>
      <article>
        <span>LSTM</span>
        <b>input, forget, and output gates plus cell state</b>
        <p>Separate gates decide what to write, retain, and expose.</p>
      </article>
      <article>
        <span>GRU</span>
        <b>update and reset gates with fewer components</b>
